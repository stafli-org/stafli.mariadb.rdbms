...
con-inspect:
	...
	@echo
		...
		docker container inspect debian8_mariadb10_1;
		@echo
		@echo Inspecting containers for debian7...
		docker container inspect debian7_mariadb10_1;
		@echo
		@echo Inspecting containers for centos7...
		docker container inspect centos7_mariadb10_1;
		@echo
		@echo Inspecting containers for centos6...
		docker container inspect centos6_mariadb10_1;
        else
		@echo Inspecting containers for $(DISTRO)...
		docker container inspect $(DISTRO)_mariadb10_1;
        endif
...
con-ips:
	...
	@echo
		...
		docker container inspect debian8_mariadb10_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for debian7...
		docker container inspect debian7_mariadb10_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos7...
		docker container inspect centos7_mariadb10_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
		@echo
		@echo Showing IP addresses of containers for centos6...
		docker container inspect centos6_mariadb10_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        else
		@echo Showing IP addresses of containers for $(DISTRO)...
		docker container inspect $(DISTRO)_mariadb10_1 | grep -e "inspect" -e "\"NetworkID\"" -B 0 -A 8;
        endif
...
con-ports:
	...
	@echo
		...
		docker container port debian8_mariadb10_1;
		@echo
		@echo Showing ports of containers for debian7...
		docker container port debian7_mariadb10_1;
		@echo
		@echo Showing ports of containers for centos7...
		docker container port centos7_mariadb10_1;
		@echo
		@echo Showing ports of containers for centos6...
		docker container port centos6_mariadb10_1;
        else
		@echo Showing ports of containers for $(DISTRO)...
		docker container port $(DISTRO)_mariadb10_1;
        endif
...
con-top:
	...
	@echo
		...
		docker container top debian8_mariadb10_1;
		@echo
		@echo Showing processes of containers for debian7...
		docker container top debian7_mariadb10_1;
		@echo
		@echo Showing processes of containers for centos7...
		docker container top centos7_mariadb10_1;
		@echo
		@echo Showing processes of containers for centos6...
		docker container top centos6_mariadb10_1;
        else
		@echo Showing processes of containers for $(DISTRO)...
		docker container top $(DISTRO)_mariadb10_1;
        endif
